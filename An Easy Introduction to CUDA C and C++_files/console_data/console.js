...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(7), __webpack_require__(41)(module)))
...
*/
var aa=__webpack_require__(1),n=__webpack_require__(20),r=__webpack_require__(35);function ba(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[c,d,e,f,g,h],k=0;a=Error(b.replace(/%s/g,function(){return l[k++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var _isPromise = _interopRequireDefault(__webpack_require__(43));
...
const tslib_1 = __webpack_require__(0);
const messages = tslib_1.__importStar(__webpack_require__(3));
const reducers_1 = tslib_1.__importDefault(__webpack_require__(190));
const redux_1 = __webpack_require__(15);
const redux_promise_1 = tslib_1.__importDefault(__webpack_require__(42));
const consoleActions = tslib_1.__importStar(__webpack_require__(71));
const react_redux_1 = __webpack_require__(25);
const Console_1 = tslib_1.__importDefault(__webpack_require__(191));
...
function reducer(state = defaultState, action) {
    switch (action.type) {
        ...
        case actions.CONSOLE_SHOW_COMMAND:
            return Object.assign({}, state, { mode: 'command', consoleText: action.text, completions: [] });
        case actions.CONSOLE_SHOW_FIND:
            return Object.assign({}, state, { mode: 'find', consoleText: '', completions: [] });
        case actions.CONSOLE_SHOW_ERROR:
            return Object.assign({}, state, { mode: 'error', messageText: action.text });
        case actions.CONSOLE_SHOW_INFO:
            return Object.assign({}, state, { mode: 'info', messageText: action.text });
        case actions.CONSOLE_HIDE_COMMAND:
            return Object.assign({}, state, { mode: state.mode === 'command' || state.mode === 'find' ? '' : state.mode });
        case actions.CONSOLE_SET_CONSOLE_TEXT:
            return Object.assign({}, state, { consoleText: action.consoleText });
        case actions.CONSOLE_SET_COMPLETIONS:
            return Object.assign({}, state, { completions: action.completions, completionSource: action.completionSource, select: -1 });
        case actions.CONSOLE_COMPLETION_NEXT: {
            let select = nextSelection(state);
            return Object.assign({}, state, { select: select, consoleText: nextConsoleText(state.completions, select, state.completionSource) });
        }
...
const react_redux_1 = __webpack_require__(25);
const react_1 = tslib_1.__importDefault(__webpack_require__(1));
const Input_1 = tslib_1.__importDefault(__webpack_require__(194));
const Completion_1 = tslib_1.__importDefault(__webpack_require__(195));
const Message_1 = tslib_1.__importDefault(__webpack_require__(201));
const consoleActions = tslib_1.__importStar(__webpack_require__(71));
...
const tslib_1 = __webpack_require__(0);
const react_1 = tslib_1.__importDefault(__webpack_require__(1));
const CompletionItem_1 = tslib_1.__importDefault(__webpack_require__(196));
const CompletionTitle_1 = tslib_1.__importDefault(__webpack_require__(200));
...
const tslib_1 = __webpack_require__(0);
const react_1 = tslib_1.__importDefault(__webpack_require__(1));
const prop_types_1 = tslib_1.__importDefault(__webpack_require__(197));
